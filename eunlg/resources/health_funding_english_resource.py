...
| value_type = health:funding:.*, value_type != .*:rank.*, value_type != _*.:comp_.*
...
| value_type = health:funding:.*:rank.*
...
class EnglishHealthFundingRawRealizer(RegexRealizer):
    def __init__(self, registry):
        ...
        super().__init__(registry, "en", r"^health:funding:([^:]*):[^:]*" + MAYBE_RANK_OR_COMP + "$", "the {}")
